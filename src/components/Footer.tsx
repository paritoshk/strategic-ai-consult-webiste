      ...
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <h2 className="text-2xl font-serif text-white mb-2">Strategic <span className="text-white">Matter</span></h2>
            <p className="text-slate text-sm max-w-xs font-serif">
          ...
          <div className="flex flex-col items-center md:items-end">
            ...
            <button 
              onClick={scrollToTop}
              className="p-3 rounded-full bg-black hover:bg-white/10 transition-colors group border border-white/10"
        ...
        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col md:flex-row justify-between items-center">
          <p className="text-slate-light text-sm font-serif">
            &copy; {new Date().getFullYear()} Strategic Matter. All rights reserved.
          </p>
          <div className="mt-4 md:mt-0 flex space-x-6">
            <a href="#" className="text-slate text-sm hover:text-white transition-colors font-serif">
              Privacy Policy
            </a>
            <a href="#" className="text-slate text-sm hover:text-white transition-colors font-serif">
              Terms of Service
